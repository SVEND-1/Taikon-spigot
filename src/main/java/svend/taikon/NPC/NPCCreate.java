...
public class NPCCreate {
    ...
    public static void Create(){
        ...
        ServerPlayer npc1 = NPCFactory.createNPC("Первый", texture1, signature1,109,99,136);
        ...
        ServerPlayer npc2 = NPCFactory.createNPC("Второй", texture2, signature2,97,99,136);
        ...
        ServerPlayer npc3 = NPCFactory.createNPC("Третий", texture3, signature3,84,99,136);
    ...
    public static void sendNPCsToPlayers( Player player) {
        ...
        for (ServerPlayer npc : npcs) {
            if (npc != null) {
                ...
                System.out.println("NPC отправлен игроку: " + player.getName());
            } else {
                System.out.println("NPC не найден!");
            }
        }
    }
